...
public class Employee {
	...
	protected int age;//if you class within same package it can access all protected members
	double salary;//default - if u don't add any access modifier it becomes default
	private long ssn;// only own class/same can have an access to private members
